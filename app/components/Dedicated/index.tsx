            ...
            <div className='mx-auto max-w-7xl px-4 my-40 sm:py-20 lg:px-8'>
                <div className='grid grid-cols-1 md:grid-cols-2 my-16'>
                    ...
                    <div className="relative">
                        ...
                        <h2 className="text-4xl lg:text-65xl pt-4 font-bold sm:leading-tight mt-5 text-center lg:text-start">Unleash your creativity, showcase your architectural prowess.</h2>
                        <p className="font-medium text-lightblack text-2xl mt-5 text-center lg:text-start">The [Competition Name] is your gateway to an exhilarating world of design, innovation, and sustainable architecture.</p>
