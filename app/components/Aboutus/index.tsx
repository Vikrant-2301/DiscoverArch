...
const Aboutdata: datatype[] = [
  {
    ...
    paragraph:
      "Inspiring architecture students to shape society's future through innovative design competitions.",
    link: "Learn more",
  },
  {
    heading: "Services.",
    ...
    paragraph:
      "Architectural design, sustainable solutions, creative competitions.",
    link: "Learn more",
  },
  {
    heading: "Our Works.",
    ...
    paragraph:
      "Elevating architectural traditions, sparking creativity, and fostering sustainable innovation",
    link: "Learn more",
  },
];
