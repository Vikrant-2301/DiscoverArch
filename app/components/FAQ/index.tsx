...
const FAQ = () => {
    return (
        <div id="faq-section" className='mx-auto max-w-7xl py-14 lg:px-8 bg-faqblue rounded-2xl my-16 faq-bg'>
                    ...
                    <Disclosure as="div" className="mt-2">
                        {({ open }) => (
                            <>
                                ...
                                <Disclosure.Panel className="px-4 pt-4 pb-2 text-base text-black font-normal opacity-50">
                                Participants are requested to submit their work in PDF format. <br />
                                </Disclosure.Panel>
                            </>
                        )}
                    </Disclosure>
                ...
                <div className="mx-auto w-full max-w-5xl rounded-2xl bg-white py-4 px-6">
                    <Disclosure as="div" className="mt-2">
                        {({ open }) => (
                            <>
                                <Disclosure.Button className="flex w-full justify-between rounded-lg px-4 py-2 text-left text-2xl font-medium">
                                    <span>What is the limit or cap on the number of team members, and can anyone participate individually?
</span>
                                    <ChevronUpIcon
                                        className={`${open ? 'rotate-180 transform' : ''
                                            } h-5 w-5 text-purple-500`}
                                ...
                                <Disclosure.Panel className="px-4 pt-4 pb-2 text-base text-black font-normal opacity-50">
                                Each team can have a maximum of four members and cannot exceed this limit. Participants who wish to participate individually can do so by filling out and submitting the details as a team leader.
                                </Disclosure.Panel>
                            </>
                        )}
                    </Disclosure>
