        ...
        <div className="grid gap-10 mx-auto sm:grid-cols-2 lg:grid-cols-4 lg:max-w-screen-lg">
          ...
          <div>
            <div className="relative pb-56 mb-4 rounded shadow lg:pb-64">
              <img
                className="absolute object-cover w-full h-full rounded"
                src="/images/jury/Surinder.jpeg"
                alt="Person"
              />
            </div>
            <div className="flex flex-col sm:text-center">
              <p className="text-lg font-bold">Ar. Surinder Bahga</p>
              <p className="mb-5 text-xs text-gray-800">
                Principal Architect at Saakaar Foundation, Chandigarh
              </p>
              <div className="flex items-center space-x-3 sm:justify-center">
                <a
                  href="/"
          ...
          <div>
            <div className="relative pb-56 mb-4 rounded shadow lg:pb-64">
              <img
                className="absolute object-cover w-full h-full rounded"
                src="/images/jury/Atul.jpeg"
                alt="Person"
              />
            </div>
            <div className="flex flex-col sm:text-center">
              <p className="text-lg font-bold">Ar. Atul Singla</p>
              <p className="mb-5 text-xs text-gray-800">
                Chief Architect at Idearch & LPU, Senior Dean LPU
              </p>
              <div className="flex items-center space-x-3 sm:justify-center">
                <a
                  href="/"
          ...
          <div>
            <div className="relative pb-56 mb-4 rounded shadow lg:pb-64">
              <img
                className="absolute object-cover w-full h-full rounded"
                src="/images/jury/Abhinav.jpg"
                alt="Person"
              />
            </div>
            <div className="flex flex-col sm:text-center">
              <p className="text-lg font-bold">Abhinav Tripathi</p>
              <p className="mb-5 text-xs text-gray-800">
